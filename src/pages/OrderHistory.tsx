      ...
      <div className="max-w-2xl mx-auto px-4 pt-4 space-y-3">
        {!user ? (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground font-medium">Sign in to see your orders</p>
            <Button className="mt-4 gradient-primary text-primary-foreground border-0 rounded-xl" onClick={() => navigate('/auth')}>
              Sign In
            </Button>
          </div>
        ) : loading ? (
